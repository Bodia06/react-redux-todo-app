	...
	return (
		<li className={styles.taskListItemContainer}>
			...
			<div className={styles.taskBtnsNav}>
				<button className={styles.taskBtnDelete} onClick={() => onDelete(id)}>
					<AiOutlineDelete />
				</button>
				<button
			...
			{isEditing && (
				<div className={styles.editFormTaskPageBackdrop}>
					<div className={styles.editFormTaskPageContainer}>
						<h2 className={styles.editFormTaskPageTitle}>Edit Task</h2>
						<TaskForm
							initialValues={{ name, lastDateToRealization, completed }}
